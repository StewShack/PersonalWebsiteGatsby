...
const NumericPage = () => {
  ...
  return (
    <Layout activemenu="testing">
      <Head title="Testing Numeric Input" description="An exercise is testing numeric input" />
      <div>
        ...
        <p>
          ...
          by
          <a href="https://www.amazon.com/Lessons-Learned-Software-Testing-Context-Driven/dp/0471081124">Lessons Learned in Software Testing: A Context Driven Approach</a>
        ...
        <p>
          <input
            ...
            onClick={() => {
              ...
              setMessage('');
              let i;
              for (i = 0; i < numericInputTest.numericInputTestResults.length; i += 1) {
